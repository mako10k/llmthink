...
| [0022](0022-node-sqlite-lifecycle-driver.md)                      | accepted | Hosted lifecycleにNode.js組込みSQLiteを限定採択する              |
| [0023](0023-withdraw-semantic-audit-artifact-v1.md)               | accepted | semantic-audit-v1 artifact提案を撤回する                         |
